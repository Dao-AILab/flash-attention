...
struct Flash_fwd_kernel_traits {
  ...
  using SmemLayoutAtomVFp16 =
      decltype(cutlass::gemm::collective::detail::ss_smem_selector<
               GMMA::Major::K, Element, decltype(cute::get<1>(TileShape_MNK{})),
               decltype(cute::get<2>(TileShape_MNK{}))>());
  using SmemLayoutVFp16 = decltype(
      tile_to_shape(SmemLayoutAtomVFp16{},
                    make_shape(shape<1>(TileShape_MNK{}),
                               shape<2>(TileShape_MNK{}), Int<kStages>{})));
  ...
  using SmemLayoutAtomO = decltype(
      cutlass::gemm::collective::detail::ss_smem_selector<
          GMMA::Major::K, ElementO, decltype(cute::get<0>(TileShape_MNK{})),
          decltype(cute::get<2>(TileShape_MNK{}))>());
  using SmemLayoutO =
  ...
  using SharedStorage =
      SharedStorageQKVO<kStages, Element, Element, ElementO, SmemLayoutQ,
...
struct Flash_bwd_kernel_traits {
  ...
  using GmemTiledCopyQdO = decltype(
  ...
  using GmemTiledCopydQ = decltype(
      make_tiled_copy(Copy_Atom<DefaultCopy, elem_type>{}, GmemLayoutAtomdQ{},
                      Layout<Shape<_1, _8>>{})); // Val layout, 8 vals per store
  ...
  using SmemLayoutdS = decltype(
      tile_to_shape(SmemLayoutAtomdS{}, select<0, 1>(TileShape_MNK{})));
  ...
  using SmemLayoutAtomdQaccTMA = decltype(
      cutlass::gemm::collective::detail::ss_smem_selector<
          GMMA::Major::K, ElementAccum, decltype(cute::get<0>(TileShape_MNK{})),
          decltype(cute::get<1>(TileShape_MNK{}))>());
  using SmemLayoutdQaccTMA = decltype(
      tile_to_shape(SmemLayoutAtomdQaccTMA{}, select<0, 2>(TileShape_MNK{})));
