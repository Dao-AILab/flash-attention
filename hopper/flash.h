...
struct Flash_fwd_params : public Qkv_params {
    ...
    int * __restrict__ batch_idx_ptr; // virtual -> actual
...
void prepare_varlen_num_blocks(Flash_fwd_params &params, cudaStream_t stream, bool packgqa, int blockM, int blockN, bool enable_pdl, bool sort_batches);
