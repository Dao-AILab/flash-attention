...
ENABLE_UPCAST = os.getenv("FLASH_ATTENTION_ENABLE_UPCAST", "FALSE") == "TRUE"
...
if not SKIP_CUDA_BUILD:
    ...
    feature_args = (
        ...
        + (["-DFLASHATTENTION_ENABLE_UPCAST"] if ENABLE_UPCAST else [])
    )
    ...
    HEAD_DIMENSIONS_FWD = (["all", "diff"] if not DISABLE_HDIMDIFF else ["all"])
