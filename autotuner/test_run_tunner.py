...
tunner = FlashFwdTunner(A100(), [q,k,v], ShapeConfig(headdim,v_headdim), ProfileConfig(batch_size,seqlen,seqlen,nheads,nheads,nheads,device,dtype,dropout_p), "autotuner/temp")    
tunner.tune()
