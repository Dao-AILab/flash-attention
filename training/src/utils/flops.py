...
try:
    from fvcore.nn import ActivationCountAnalysis, FlopCountAnalysis, flop_count_str, flop_count_table
...
def profile_deepspeed(model, input_size=(3, 224, 224), input_dtype=torch.float32, batch_size=1, detailed=False):
