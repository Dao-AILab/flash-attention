...
struct Flash_fwd_kernel_traits : public Base {
    ...
    using SmemCopyAtomM = Copy_Atom<DefaultCopy, elem_type>;
    ...
    static constexpr int kMBlockN = kBlockN % 64 == 0 ? 64 : 32;
    static constexpr int kMSwizzle = kMBlockN == 32 ? 2 : 3;
    using SmemLayoutAtomM = decltype(
        composition(Swizzle<kMSwizzle, 3, 3>{},
                    Layout<Shape<Int<8>, Int<kMBlockN>>,
                           Stride<Int<kMBlockN>, _1>>{}));
    using SmemLayoutM = decltype(tile_to_shape(
        SmemLayoutAtomM{},
    ...
    static constexpr int kSmemMCount = size(SmemLayoutM{});
    static constexpr int kSmemQSize = kSmemQCount * sizeof(Element);
    static constexpr int kSmemKVSize = kSmemKVCount * sizeof(Element);
    static constexpr int kSmemMSize = kSmemMCount * sizeof(Element);
    static constexpr int kSmemSize = Share_Q_K_smem ? std::max(kSmemQSize, kSmemKVSize) + kSmemMSize : kSmemQSize + kSmemKVSize + kSmemMSize;
    ...
    using GmemLayoutAtomM = Layout<Shape <Int<kNThreads / kGmemThreadsPerRowB>, Int<kGmemThreadsPerRowB>>,
                                   Stride<Int<kGmemThreadsPerRowB>, _1>>;

    using GmemTiledCopyM = decltype(
...
struct Flash_bwd_kernel_traits : public Base {
    ...
    static constexpr int kSmemSize1colblock = kSmemQdOSize
        + (!Is_V_in_regs
           ? kSmemKVSize + kSmemdSSize + kSmemPSize + kSmemMSize
           : std::max(kSmemKVSize, kSmemKVSize / 2 + kSmemdSSize + kSmemPSize)) + kSmemMSize;
    static constexpr int kSmemSize1rowblock = kSmemQdOSize / 3 * 2 + kSmemKVSize / 2 * 3
        + kSmemdSSize + kSmemPSize + kSmemMSize;
