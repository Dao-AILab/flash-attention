...
inline __device__ void compute_attn(const Params &params) {
    ...
    flash::compute_attn_1rowblock<Kernel_traits, Is_dropout, Is_causal, Is_local, Has_alibi, Is_even_MN, Is_even_K, Is_softcap, Return_softmax, Is_tree_attention>(params, bidb, bidh, m_block);
}
