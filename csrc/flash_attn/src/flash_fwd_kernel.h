...
template<typename Kernel_traits, bool Is_dropout, bool Is_causal, bool Is_mlm, bool Is_local, bool Is_even_MN, bool Is_even_K, bool Return_softmax, typename Params>
...
template<typename Kernel_traits, bool Is_causal, bool Is_mlm, bool Is_local, bool Is_even_MN, bool Is_even_K, bool Split, bool Append_KV, typename Params>
...
inline __device__ void compute_attn(const Params &params) {
    ...
    flash::compute_attn_1rowblock<Kernel_traits, Is_dropout, Is_causal, Is_mlm, Is_local, Is_even_MN, Is_even_K, Return_softmax>(params, bidb, bidh, m_block);
}
...
inline __device__ void compute_attn_splitkv(const Params &params) {
    ...
    flash::compute_attn_1rowblock_splitkv<Kernel_traits, Is_causal, Is_mlm, Is_local, Is_even_MN, Is_even_K, Split, Append_KV>(params, bidb, bidh, m_block, n_split_idx, num_n_splits);
}
