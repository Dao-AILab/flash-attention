...
DEFINE_FLASH_BACKWARD_KERNEL(flash_bwd_dq_dk_dv_loop_kernel, bool Is_dropout, bool Is_causal, bool Has_alibi, bool Has_rpe_bias, bool Is_even_M, bool Is_even_K) {
       ...
       FLASH_NAMESPACE::compute_dq_dk_dv<Kernel_traits, Is_dropout, Is_causal, Has_alibi, Has_rpe_bias, Is_even_M, Is_even_K>(params);
    #else
...
DEFINE_FLASH_BACKWARD_KERNEL(flash_bwd_dq_dk_dv_loop_seqk_parallel_kernel, bool Is_dropout, bool Is_causal, bool Is_local, bool Has_alibi, bool Has_rpe_bias, bool Is_even_MN, bool Is_even_K, bool Is_softcap) {
        ...
        FLASH_NAMESPACE::compute_dq_dk_dv_seqk_parallel<Kernel_traits, Is_dropout, Is_causal, Is_local, Has_alibi, Has_rpe_bias, Is_even_MN, Is_even_K, Is_softcap>(params);
    #else
        FLASH_UNSUPPORTED_ARCH
    #endif
}
                ...
                ALIBI_SWITCH(params.alibi_slopes_ptr != nullptr, Has_alibi, [&] {
                    SOFTCAP_SWITCH(params.softcap > 0.0, Is_softcap, [&] {
                        RPE_BIAS_SWITCH(params.rpe_weights_ptr != nullptr, Has_rpe_bias, [&] {
                            ...
                            auto kernel = &flash_bwd_dq_dk_dv_loop_seqk_parallel_kernel<Kernel_traits, Is_dropout && !Is_softcap, Is_causal, Is_local && !Is_causal, Has_alibi, Has_rpe_bias, IsEvenMNConst && IsEvenKConst && !Is_local && !Has_alibi && !Has_rpe_bias && Kernel_traits::kHeadDim <= 128, IsEvenKConst && !Has_alibi && !Has_rpe_bias, Is_softcap>;
