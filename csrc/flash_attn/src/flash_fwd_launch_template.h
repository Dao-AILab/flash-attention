...
template<typename Kernel_traits, bool Is_dropout, bool Is_causal, bool Is_alibi, bool Is_even_N, bool Is_even_K, bool Return_softmax>
__global__ void flash_fwd_kernel(Flash_fwd_params params) {
    flash::compute_attn<Kernel_traits, Is_dropout, Is_causal, Is_alibi, Is_even_N, Is_even_K, Return_softmax>(params);
}
    ...
    BOOL_SWITCH(is_even_N, IsEvenNConst, [&] {
        BOOL_SWITCH(is_even_K, IsEvenKConst, [&] {
            BOOL_SWITCH(return_softmax, ReturnSoftmaxConst, [&] {
                ...
                auto kernel = &flash_fwd_kernel<Kernel_traits, Is_dropout, Is_causal, Is_alibi, IsEvenNConst, IsEvenKConst, ReturnSoftmaxConst && Is_dropout>;
