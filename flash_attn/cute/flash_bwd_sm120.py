...
class FlashAttentionBackwardSm120:
    ...
    def apply_score_mod(
        ...
        """Apply forward score modification for SM120 backward pass."""
        ...
        tScS_idx = thr_copy_s2r.partition_D(tScS)
    ...
    def apply_score_mod_bwd(
        ...
        """Apply backward score modification (joint graph) for SM120."""
            ...
            for iter_idx in cutlass.range(loop_count, unroll=1):
                ...
                for stage in cutlass.range_constexpr(num_stages):
                    ...
                    if const_expr(self.score_mod_bwd is not None):
                        ...
                        tScS_idx_bwd = thr_copy_s2r.partition_D(tScS_bwd)
                    ...
                    tdPrdS_r2s = cute.make_tensor(
                        tdPrdS_cvt.iterator, tdPcdS_r2s_dst[None, stage, 0, 0].shape
                    )
