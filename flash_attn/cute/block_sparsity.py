...
@cute.jit
def process_sparse_block_lists_for_tile(
    ...
    if mask_empty:
        ...
        kv_producer_state = process_block_list(
            curr_full_block_idx,
            curr_full_block_cnt,
...
@cute.jit
def consume_sparse_block_lists_for_tile(
    blocksparse_tensors: BlockSparseTensors,
    batch_idx,
    head_idx,
    m_block,
    ...
    Mirrors `process_sparse_block_lists_for_tile` so that the consumer pipeline
    """
