...
try:
    ...
    long_description = "CUTE: CUtlass Templates for flash attention - Pure Python implementation"

setup(
    name="flash-attn-cute",
    version="0.1.0",
    author="Flash Attention Contributors",
    description="CUTE: CUtlass Templates for flash attention - Pure Python implementation",
