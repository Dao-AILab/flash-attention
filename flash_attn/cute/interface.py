...
def _flash_attn_fwd(
    ...
    return out, lse, p, row_max, rng_state, dropout_mask
...
class FlashAttnFunc(torch.autograd.Function):
    ...
    def forward(
        ...
        if shared_kv and v.shape[-1] == 512:
            ...
            q = k = None
        out, lse, p, row_max, rng_state, dropout_mask = _flash_attn_fwd(
            q,
            k,
            v,
            qv=qv,
        ...
        ctx.save_for_backward(q, k, v, qv, out, lse, p, row_max, rng_state, gather_kv_indices, *(aux_tensors or ()))
