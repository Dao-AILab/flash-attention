...
from flash_attn.cute.block_sparsity import BlockSparseMask
...
def _flash_attn_fwd(
    ...
    block_sparse_mask: Optional[BlockSparseMask] = None,
    ...
    sparse_tensors = block_sparse_mask.as_cute_tuple() if block_sparse_mask is not None else None
