    ...
    if num_splits != 1:
        ...
        if pack_gqa:
            supports_varlen_pack_gqa_splitkv = (
                ...
                and (
                    (score_mod is None and aux_tensors is None)
...
def _flash_attn_fwd(
    ...
    if tile_mn is None:
        if arch // 10 == 12:
            # SM120 has a smaller SMEM/occupancy envelope than SM80. On RTX 5060,
            # 64x64 is the best default across the dense fp16/bf16 baseline matrix.
