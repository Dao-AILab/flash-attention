...
@_torch_custom_op_wrapper("flash_attn::_sparse_attn_forward", mutates_args=(), device_types="cuda")
def _sparse_attn_forward(
    ...
    out, softmax_lse = flash_attn_gpu.fwd_sparse(
        q,
        k,
        v,
        block_count,
...
@_torch_custom_op_wrapper("flash_attn::_sparse_attn_varlen_forward", mutates_args=(), device_types="cuda")
def _sparse_attn_varlen_forward(
    ...
    q, k, v = [maybe_contiguous(x) for x in (q, k, v)]
    out, softmax_lse = flash_attn_gpu.varlen_fwd_sparse(
        q,
        k,
        v,
        block_count,
