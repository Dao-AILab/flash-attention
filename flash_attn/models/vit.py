...
class VisionTransformer(nn.Module):
    ...
    def load_state_dict(self, state_dict, strict=True):
        ...
        if patch_embed_weight.dim() == 4:
            ...
            state_dict["patch_embed.proj.weight"] = rearrange(patch_embed_weight, "o c h w -> o (c h w)")
        ...
        if self.blocks[-1].mixer.cross_attn and f"blocks.{n_layer - 1}.mixer.Wqkv.weight" in state_dict:
