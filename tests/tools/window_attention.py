...
logger = logging.getLogger("Window_attention")
...
class WindowAttention(nn.Module):
    ...
    def __init__(self, dim, window_size, num_heads, qkv_bias=True, qk_scale=None, attn_drop=0., proj_drop=0., init_para = {}):
...
# for test without using apex but using fp16
class WindowAttentionFP16(nn.Module):
    r""" Window based multi-head self attention (W-MSA) module with relative position bias.
    It supports both of shifted and non-shifted window.
    ...
    def __init__(self, dim, window_size, num_heads, qkv_bias=True, qk_scale=None, attn_drop=0., proj_drop=0., init_para = {}):
        ...
        self.qkv = nn.Linear(dim, dim * 3, bias=qkv_bias, dtype = torch.half)
